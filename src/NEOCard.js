			...
			<>
				...
				<Modal show={this.state.showNEODetailModal}
					...
					<Modal.Body>
						...
						<p>
							Earth closest approach date full : <span className="text-6d0000">
							<Moment format="HH">{neo_object.close_approach_date_full}</Moment> 
